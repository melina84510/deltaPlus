    ...
    <main>
        <section>
            ...
            <div>
                <div>
                    <h2>Notre vision</h2>
                    <p>Chez Delta Plus, nous croyons que la protection des personnes est essentielle à la performance des entreprises. C’est pourquoi nous nous efforçons de proposer des solutions complètes et innovantes qui anticipent les évolutions du marché et les nouvelles attentes en matière de sécurité.</p>
                    <h2>Notre mission?</h2>
                    <p>Notre métier est de protéger les femmes et les hommes au travail.
                    Pour cela nous concevons et fabriquons dans le monde entier des solutions complètes de protection individuelle et collective pour les professionnels.</p>
                </div>
                <div>
                    <!-- <img class="" src="/images/mission.webp" alt=""> -->
                </div>
            </div>
        </section>
        <section>
        ...
        <section>
            ...
            <div>
                <h2>Les métiers chez Delta Plus</h2>
            </div>
            <div>
                <p>Chez Delta Plus, nous croyons que le succès de notre entreprise repose avant tout sur les talents et les compétences de nos équipes. Chaque jour, nos collaborateurs contribuent à notre mission de protéger les hommes au travail, en mettant en œuvre leur expertise et leur savoir-faire dans des domaines variés. Que vous soyez passionné par la logistique, les ressources humaines, le marketing ou les technologies de l’information, Delta Plus offre un large éventail d'opportunités de carrière. Découvrez nos différents métiers et rejoignez une équipe dynamique et internationale !</p>
            </div>
            <div class='content1 '>
                <div>
                ...
                <div>
                    <a href="">
                       <img src="/images/exp.webp" alt="">
                        <h3>Export</h3>
                        <p>L'export chez Delta Plus, c’est accompagner nos clients dans plus de 90 pays. Nos équipes travaillent au quotidien pour faciliter le développement international de nos produits, en assurant le suivi commercial, la gestion des formalités douanières et la coordination logistique.</p> 
                    </a>
                </div>
                <div>
                    <a href="">
                        <img src="/images/co.webp" alt="">
                        <h3>Commerce</h3>
                        <p>Les équipes commerciales de Delta Plus sont au plus près de nos clients pour comprendre leurs besoins et leur proposer des solutions adaptées. Que ce soit en B2B ou à l'international, les commerciaux jouent un rôle clé dans le développement de notre portefeuille clients et dans la croissance de l’entreprise.</p>
                    </a>
                </div>
                <div>
                ...
                <div>
                    <a href="https://deltaplus.optimhum.fr/metiers/accueil">
                        ...
                        Dotés d’un excellent sens relationnel, d’une présentation soignée et d’une grande capacité d’adaptation, ces experts savent gérer aussi bien les urgences que les imprévus tout en restant disponibles et à l’écoute.</p>
                    </a>
                </div>
                <div>
